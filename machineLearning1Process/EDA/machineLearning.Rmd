...
df_clusters <- read.csv ("../cluster.csv")
df_root <- read.csv ("../kc_house_data.csv")


df_clusters$hclust=as.numeric(df_clusters$hclust)
df_clusters$cluster_final[df_clusters$hclust==2 | df_clusters$hclust==8] <- "top"
df_clusters$cluster_final[df_clusters$hclust==1 | df_clusters$hclust==5 | df_clusters$hclust==9] <- "low"
df_clusters$cluster_final[df_clusters$hclust==3 | df_clusters$hclust==4 | df_clusters$hclust==6 | df_clusters$hclust==7  ] <- "med"


```

## Resumen Cluster 1 (Top)

```{r Filtrado cluster 1}

cluster_1 = filter(df_clusters, cluster_final == "top")
...
## Resumen Cluster 2 (Med)

```{r Filtrado cluster 2}

cluster_2 = filter(df_clusters, cluster_final == "med")
...
## Resumen Cluster 3 (Low)

```{r Filtrado cluster 3}

cluster_3 = filter(df_clusters, cluster_final == "low")
