...
# Discretizamos las variables con pocas clases CAMBIO P1 incluir "Sex" y "Embarked"
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
ggplot(data = totalData[1:filas,],aes(x=Embarked,fill=Survived))+geom_bar(position="fill")+facet_wrap(~Sex)
```
