# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 09:07:47 2020
...
@author: Pablo Olmos, Verónica Gómez, Carlos Grande
"""
...
stops_df = pd.read_csv("C:/Users/olmosp/Desktop/pp_utf8.csv", sep=',', encoding='utf-8')
stops_df.head()
g = Graph()
