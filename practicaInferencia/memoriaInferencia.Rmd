...
```
Trabajaremos sobre dos muestras, mas con 5000 entradas y mas2 con 25. En funcion del ejercicio indicaremos con que muestra estamos trabajando.
...
#importe solicitado del cliente Media Poblacion
media.importe=mean(baset$AMT_CREDIT)
dt.importe=sd(baset$AMT_CREDIT)
media.importe
dt.importe
```
...
media.ingresos=mean(baset$AMT_INCOME_TOTAL)
media.ingresos
```
...
#edad media poblacional 
dias=(baset$DAYS_BIRTH*-1)/365.25
...
antg=(baset$DAYS_EMPLOYED)/365.25
