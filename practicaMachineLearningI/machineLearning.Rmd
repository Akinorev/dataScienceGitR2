...
```{r var_price_clusters, include=TRUE, warning=FALSE}
...
bxp
#var_price_clusters = df_cuantitativas_clusters$price
#name = "price"

# Descripción de la variable
#describe(var_price_clusters)

# Visualización de la variable
#p1_clusters <- phist(df_cuantitativas_clusters, ., name)
#lines(p1_cluster_1,p1,col="green")
#p2_clusters <- pbox(var_price_clusters, name)
#grid.arrange(p1_clusters, p2_clusters, nrow=1)
```
